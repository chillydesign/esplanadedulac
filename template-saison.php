        ...
        <header class="event_header">
            ...
            <div class="container">
                <div class="event_header_text">
                    <h1>
                        <?php if (isset($_GET['for_families']) and $_GET['for_families'] == 1) {
                            echo 'À voir en famille';
                        } elseif ($_GET['categorie'] == 'theatre') {
                            echo 'Théâtre';
                        } elseif ($_GET['categorie'] == 'danse') {
                            echo 'Danse';
                        } elseif ($_GET['categorie'] == 'musique') {
                            echo 'Musique';
                        } elseif ($_GET['categorie'] == 'cirque') {
                            echo 'Cirque';
                        } elseif ($_GET['categorie'] == 'magie') {
                            echo 'Magie';
                        } elseif ($_GET['categorie'] == 'jeune-public') {
                            echo 'Jeune Public';
                        } else {
                            the_title();
                        } ?>
